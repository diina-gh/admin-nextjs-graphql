...
export default function Sidebar({onOpen2Change, open2}) {
  ...
  return (
    ...
    <aside className="gt-sidebar w-60 bg-white rounded-xl shadow py-5 overflow-y-auto" aria-label="Sidebar">
        ...
        <div className="overflow-y-auto px-3">
            ...
            <ul className="space-y-2">
                ...
                <li>
                    <button type="button" className="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
