                    ...
                    <div className='app-body'>
                        ...
                        <div className='w-full h-full bg-white rounded-xl overflow-y-scroll p-4'>
                            ...
                            <div className='w-full flex flex-row mt-2'>
                                ...
                                <div className='px-2 py-1 rounded-xl bg-purple-600 bg-opacity-90 text-white text-xs font-medium self-center'>{items?.newsletters?.count ? items?.newsletters?.count: 0 }</div>
