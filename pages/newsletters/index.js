                    ...
                    <div className='app-body rounded-xl'>
                        ...
                        <div className='w-full h-full bg-white rounded-xl overflow-y-scroll pt-4 pb-3'>
                            ...
                            <div className='w-full flex flex-row mt-2 px-4'>
                                ...
                                <div className='text-lg font-bold text-purple-600 mr-2 self-center'>Newsletters</div>
                                <div className='px-2 py-1 rounded-xl bg-gradient-to-r from-purple-700 to-purple-300 text-white text-[11.5px] font-medium self-center'>{items?.newsletters?.count ? items?.newsletters?.count: 0 }</div>
                            ...
                            <div className="w-full flex flex-col overflow-x-auto mt-4">
                                <div className="w-full overflow-x-auto">
                                    <div className="align-middle inline-block min-w-full">
                                        ...
                                        {(items && items.newsletters && items?.page == null && items?.filter == null && items?.orderBy == null ) &&
                            ...
                            <div className='w-full flex flex-row justify-end mt-6'>
                                <Pagination 
                                    ...
                                    totalItems={items?.newsletters?.count}  
                                    pageNeighbours={2} 
