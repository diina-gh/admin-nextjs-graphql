                                    ...
                                    <div className='app-form overflow-y-auto mt-3 px-5'>
                                        ...
                                        <div className='col-span-3 bg-gray-200 bg-opacity-60 rounded-xl px-5 py-6'>
                                            ...
                                            <div className="w-full">
                                                ...
                                                <div className="mt-1">
                                                    <textarea value={this.state.desc} onChange={(e) => this.setState({desc:e.target.value }) }  id="desc" name="desc" rows={6}  className="mt-1 w-full shadow-sm text-sm border border-gray-400 focus:border-0 focus:ring-2 focus:ring-purple-500 shadow-inner bg-white bg-opacity-90 rounded-md px-2 py-3" placeholder="Donner une description" />
                                                </div>
                                            </div>
