...
import { deletePaymentMethod, getPaymentMethods } from '../../hooks/paymentMethod';
...
export default function Index() {
    ...
    var { items, isLoading, isError, mutate } = getPaymentMethods(page,take,filter, orderBy, fields )
    ...
    async function deleteItem (e, id){
        ...
        var {response } = await deletePaymentMethod(id)
                    ...
                    <div className='app-body relative rounded-xl'>
                        ...
                        <div className='w-full h-full bg-white rounded-xl overflow-y-scroll pt-4 pb-3'>
                            ...
                            <div className='w-full flex flex-row mt-2 px-4'>
                                ...
                                <div className='text-lg font-bold text-purple-600 mr-2 self-center'>Modes de paiements</div>
                                <div className='px-2 py-1 rounded-xl bg-gradient-to-r from-purple-700 to-purple-300 text-white text-[11.5px] font-medium self-center'>{items?.paymentMethods?.count ? items?.paymentMethods?.count: 0 }</div>
                            ...
                            <div className='w-full flex flex-row justify-between px-4 mt-4'>
                                ...
                                <div className='flex flex-row'>
                                    ...
                                    <Link href='modes_de_paiement/form' > 
                            ...
                            <div className="w-full flex flex-col overflow-x-auto mt-4">
                                <div className="w-full overflow-x-auto">
                                    <div className="align-middle inline-block min-w-full">
                                        ...
                                        {(items && items.paymentMethods && items?.page == null && items?.filter == null && items?.orderBy == null ) &&
                                            <table className="min-w-full divide-y divide-gray-200 border-b border-gray-200">
                                                ...
                                                <tbody className="bg-white divide-y divide-gray-200">
                                                    {items.paymentMethods.paymentMethods.map((item, i) => (
                                                        <tr key={item.id} className={(i%2==0) ? "" : "bg-gray-100 bg-opacity-50"}>
                                                            ...
                                                            <td className="px-2 py-3 whitespace-nowrap text-right flex flex-row justify-end">
                                                                ...
                                                                <div className="flex flex-row">
                                                                    <Link  href={{pathname: 'modes_de_paiement/form', query: { id: item.id},}} >
                            ...
                            <div className='w-full flex flex-row justify-end mt-6'>
                                <Pagination 
                                    ...
                                    totalItems={items?.paymentMethods?.count}  
                                    pageNeighbours={2} 
