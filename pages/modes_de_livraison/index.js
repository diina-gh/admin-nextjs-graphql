                    ...
                    <div className='app-body relative rounded-xl'>
                        ...
                        <div className='w-full h-full bg-white rounded-xl overflow-y-scroll pt-4 pb-3'>
                            ...
                            <div className='w-full flex flex-row mt-2 px-4'>
                                ...
                                <div className='px-2 py-1 rounded-xl bg-gradient-to-r from-purple-700 to-purple-300 text-white text-[11.5px] font-medium self-center'>{items?.shippingMethods?.count ? items?.shippingMethods?.count: 0 }</div>
