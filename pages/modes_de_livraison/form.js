...
class Index extends Component {
    ...
    constructor(props){
        super(props);
        this.state = { block: false, id:null, name: '', code: '', desc:''};
    ...
    checkInput = (e) => {
        ...
        e.preventDefault()
        const {name, code, desc} = this.state
        var errorMessage
                                    ...
                                    <div className='app-form overflow-y-auto mt-3 px-5'>
                                        ...
                                        <div className='col-span-2 px-4 py-4 '>
                                            <div className='flex flex-row'>
                                                ...
                                                <div className='self-center text-xl font-semibold text-gray-900 '>Mode de livraison</div>
                                            </div>
                                        ...
                                        <div className='col-span-3 bg-gray-200 bg-opacity-60 rounded-xl px-5 py-6'>
                                            ...
                                            <div className="w-full">
                                                ...
                                                <div className="mt-1">
                                                    <textarea value={this.state.desc} onChange={(e) => this.setState({desc:e.target.value }) }  id="desc" name="desc" rows={6}  className="mt-1 w-full shadow-sm text-sm border border-gray-400 shadow-inner bg-white bg-opacity-90 rounded-md px-2 py-3" placeholder="Donner une description" />
                                                </div>
                                            </div>
