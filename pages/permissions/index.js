...
export default function Index() {
    ...
    var { items, isLoading, isError, mutate } = getPermissions(page,take,filter, orderBy, fields )
    ...
    async function deleteItem (e, id){
        ...
        var {response } = await deletePermission(id)
                    ...
                    <div className='app-body relative rounded-xl'>
                        ...
                        <div className='w-full h-full bg-white rounded-xl overflow-y-scroll pt-4 pb-3'>
                            ...
                            <div className='w-full flex flex-row px-4'>
                                ...
                                <div className='text-lg font-bold text-purple-600 mr-2 self-center'>Permissions</div>
                                <div className='px-2 py-1 rounded-xl bg-gradient-to-r from-purple-700 to-purple-300 text-white text-[11.5px] font-medium self-center'>{items?.permissions?.count ? items?.permissions?.count: 0 }</div>
                            ...
                            <div className="w-full flex flex-col overflow-x-auto mt-4">
                                <div className="w-full overflow-x-auto">
                                    <div className="align-middle inline-block min-w-full">
                                        ...
                                        {(items && items.permissions && items?.page == null && items?.filter == null && items?.orderBy == null ) &&
                                            <table className="min-w-full divide-y divide-gray-200 border-b border-gray-200">
                                                ...
                                                <tbody className="bg-white divide-y divide-gray-200">
                                                    {items.permissions.permissions.map((item, i) => (
                            ...
                            <div className='w-full flex flex-row justify-end px-4 mt-6'>
                                <Pagination 
                                    ...
                                    totalItems={items?.permissions?.count}  
                                    pageNeighbours={2} 
