...
export function getRegions (page, take, filter, orderBy, fields) {
...
export async function allRegions(fields){
    const data = await graphQLClient.request(regionsQuery, fields)
    console.info("The response : ", data )
    return {response: data.regions}
}

export async function getRegion (id, fields) {
