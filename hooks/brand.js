...
export function getBrands (page, take, filter, orderBy, fields) {
...
export async function allBrands(fields){
    const data = await graphQLClient.request(brandsQuery, fields)
    console.info("The response : ", data )
    return {response: data.brands}
}

export async function getBrand (id, fields) {
