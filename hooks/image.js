...
export async function saveImage (id, imageUrl, imageref, productId = null, optionId = null, brandId = null, categoryId= null ) {
    var variables = {id: filterInt(id) , "url": imageUrl, "imageref": imageref, "productId": filterInt(productId) , "optionId": filterInt(optionId) , "brandId": filterInt(brandId), "categoryId": filterInt(categoryId) }
